...
const RealizarTransferencia = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (cuentaOrigen === cuentaDestino) throw new Error('Las cuentas origen y destino no pueden ser iguales.');
      ...
      // Validar empleado
      if (!empleado.trim()) throw new Error('El código del empleado es obligatorio.');
      const empExiste = await validarEmpleado(empleado);
      if (!empExiste) throw new Error(`El empleado "${empleado}" no existe.`);
