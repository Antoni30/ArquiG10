...
-- =============================================
CREATE TABLE auth (
    ID_USUARIO INT IDENTITY(1,1) PRIMARY KEY, -- Identificador único autoincremental
    USUARIO NVARCHAR(50) NOT NULL UNIQUE,     -- Campo de usuario (único)
    PASSWORD VARBINARY(256) NOT NULL          -- Contraseña en formato encriptado
);
